...
parser.add_argument('--subfolder', type=str, default='demo',
                    help='Data subfolder.')
...
np.save(subfolder + '/loc_train' + suffix + '.npy', loc_train)
np.save(subfolder + '/vel_train' + suffix + '.npy', vel_train)
np.save(subfolder + '/edges_train' + suffix + '.npy', edges_train)

np.save(subfolder + '/loc_valid' + suffix + '.npy', loc_valid)
np.save(subfolder + '/vel_valid' + suffix + '.npy', vel_valid)
np.save(subfolder + '/edges_valid' + suffix + '.npy', edges_valid)

np.save(subfolder + '/loc_test' + suffix + '.npy', loc_test)
np.save(subfolder + '/vel_test' + suffix + '.npy', vel_test)
np.save(subfolder + '/edges_test' + suffix + '.npy', edges_test)
